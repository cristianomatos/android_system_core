...
void restart_root_service(int fd, void *cookie)
{
    ...
    char crdroid_version[PROPERTY_VALUE_MAX];
    ...
    if (getuid() == 0) {
        ...
        property_get("ro.crdroid.version", crdroid_version, "");

        if (strlen(crdroid_version) > 0 && strcmp(build_type, "eng") != 0 && (atoi(value) & 2) != 2) {
